...
from selection.candidate_generation import parse_candidates
...
class DropFilteredAlgorithm(SelectionAlgorithm):
    def __init__(self, database_connector, parameters=None):
        ...
        start = time.time()
        self.cands = parse_candidates(self.parameters['candidate_file'], self.parameters['max_index_width'])
        logging.info(f'CANDIDATE PARSE TIME: {time.time() - start}')
    ...
    def _calculate_best_indexes(self, workload):
        ...
        remaining_indexes = set(self.cands)
